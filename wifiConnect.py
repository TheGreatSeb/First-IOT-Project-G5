import utime
#from wifiConnect import MQTTClient
import sys
import network
import os
try:
    ...
    print("ERROR: no credentials found! Credentials are kept in passwords.py, please add them there!")
    raise
...
if attempt_count == MAX_ATTEMPTS:
    print('ERROR: Failed to connect to network, maybe password is wrong?')
    sys.exit()
besked = ""
